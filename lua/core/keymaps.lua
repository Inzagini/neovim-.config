...
--Scroll Jump
vim.keymap.set("n", "<C-u>", "5j")
vim.keymap.set("n", "<C-i>", "5k")

-- Map to <leader>w in normal mode
function WrapWord()
	-- Ask for opening character
	local open = vim.fn.input("Wrap with: ")
	if open == "" then
		return
	end
	...
	-- Run ciw to delete inner word and enter insert mode
	vim.cmd("normal! ciw")

	-- Insert opening char + old word + closing char
